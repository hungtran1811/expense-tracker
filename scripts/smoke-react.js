...
const checks = [
  ...
  [existsSync(resolve(root, "capacitor.config.ts")), "capacitor config"],
  [existsSync(resolve(root, "electron/main.cjs")), "electron main"],
  [existsSync(resolve(root, "android")), "android project"],
