...
const requiredIds = [
  ...
  "sessionEditor",
  "sessionReviewTable",
  "classesPresentationPane",
  "classPresentationSelect",
  "presentationAttendanceList",
  "presentationRandomButton",
  "presentationUsedReset",
  "presentationLeaderboardSession",
